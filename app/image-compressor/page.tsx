  ...
  return (
    <div className="min-h-screen bg-slate-900">
      ...
      <div className="container mx-auto px-4 py-8">
        {/* 工具介绍 */}
        <div className="mb-8">
          <Card className="border-2 border-slate-700 bg-slate-900/50 backdrop-blur-sm hover:shadow-xl transition-all duration-500">
            ...
            <CardContent className="pt-0">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="flex items-center space-x-4 p-4 rounded-lg bg-slate-800/50 group hover:bg-slate-800/50 transition-all duration-300 hover:scale-105 border-2 border-slate-700 hover:border-cyan-600">
                  ...
                  <div>
                    ...
                    <span className="text-slate-300 text-sm">JPG、PNG、WebP等</span>
                  </div>
                </div>
                
                <div className="flex items-center space-x-4 p-4 rounded-lg bg-emerald-950/50 group hover:bg-emerald-900/50 transition-all duration-300 hover:scale-105 border-2 border-emerald-700">
                  ...
                  <div>
                    <span className="text-emerald-300 font-bold text-lg block">⚡ 快速 + 详细模式</span>
                    <span className="text-emerald-400 text-sm">预设配置 + 专业调整</span>
                  </div>
                </div>
                
                <div className="flex items-center space-x-4 p-4 rounded-lg bg-slate-800/50 group hover:bg-slate-800/50 transition-all duration-300 hover:scale-105 border-2 border-slate-700 hover:border-emerald-600">
                  <div className="p-3 rounded-full bg-gradient-to-r from-emerald-500 to-green-600 group-hover:scale-110 transition-transform duration-300 shadow-lg shadow-emerald-500/25">
                    <Image className="h-5 w-5 text-white" />
                  </div>
                  <div>
                    <span className="text-emerald-400 font-bold text-lg block">📦 批量处理支持</span>
                    <span className="text-slate-300 text-sm">同时处理多个文件</span>
                  </div>
                </div>
              </div>
            </CardContent>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            {state.files.length > 0 && (
              <Card className="border-2 border-slate-700 bg-slate-900/50 backdrop-blur-sm hover:shadow-lg transition-all duration-300">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center space-x-3">
                        <span className="text-slate-300">⚡️ 准备压缩</span>
                        <span className="px-3 py-1 rounded-full bg-slate-800 text-cyan-400 font-bold text-lg">
          ...
          <div className="space-y-8">
            ...
            <Card className="border-2 border-blue-600 bg-slate-900/50 backdrop-blur-sm">
              ...
              <CardContent className="space-y-6">
                <div className="group p-4 rounded-lg bg-cyan-950/50 border border-cyan-700 hover:bg-cyan-900/50 transition-colors">
                  <div className="flex items-center space-x-2 mb-2">
                    <span className="text-xl">⚡️</span>
                    <h4 className="font-medium text-sm text-cyan-300">快速模式</h4>
                  </div>
                ...
                <div className="group p-4 rounded-lg bg-blue-950/50 border border-blue-700 hover:bg-blue-900/50 transition-colors">
                  <div className="flex items-center space-x-2 mb-2">
                    <span className="text-xl">⚙️</span>
                    <h4 className="font-medium text-sm text-blue-300">详细模式</h4>
                  </div>
                ...
                <div className="group p-4 rounded-lg bg-emerald-950/50 border border-emerald-700 hover:bg-emerald-900/50 transition-colors">
                  <div className="flex items-center space-x-2 mb-2">
                    <span className="text-xl">📦</span>
                    <h4 className="font-medium text-sm text-emerald-300">批量处理</h4>
                  </div>
                ...
                <div className="group p-4 rounded-lg bg-lime-950/50 border border-lime-700 hover:bg-lime-900/50 transition-colors">
                  <div className="flex items-center space-x-2 mb-2">
                    <span className="text-xl">🎨</span>
                    <h4 className="font-medium text-sm text-lime-300">格式支持</h4>
                  </div>
                  <p className="text-sm text-lime-400 leading-relaxed">
            ...
            <Alert className="border-2 border-emerald-600 bg-emerald-950/30">
              <AlertDescription className="flex items-center space-x-2">
                ...
                <div>
                  <span className="font-semibold text-emerald-300">🔒 安全提示：</span>
                  <span className="text-emerald-400">图片压缩在浏览器本地进行，您的数据不会上传到服务器，保护隐私安全 ✨</span>
                </div>
              </AlertDescription>
            </Alert>
          </div>
